...
window.onload = function () {
    ...
    function renderItems () {
        for (var info of baseDeDatos) {
            ...
            // Boton ver más 
            var miBotonVerMas = document.createElement('button');
            miBotonVerMas.setAttribute('id', 'botonVerMas');
            miBotonVerMas.setAttribute('data-toggle', 'modal');
            miBotonVerMas.setAttribute('data-target', '#modalVerMas');
            miBotonVerMas.setAttribute('style', 'position: relative');
            miBotonVerMas.classList.add('btn', 'btn-primary');
            miBotonVerMas.textContent = 'info';
            ...
            container.appendChild(miBotonVerMas);
